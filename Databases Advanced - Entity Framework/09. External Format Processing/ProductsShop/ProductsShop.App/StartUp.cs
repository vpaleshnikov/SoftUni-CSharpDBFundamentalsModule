namespace ProductsShop.App
{
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            ExportJson();
            Console.WriteLine(@"Successfully exported json data! View in directory ""Export\Json""");
            ...
            ExportXml();
            Console.WriteLine(@"Successfully exported xml data! View in directory ""Export\Xml""");
        }
        ...
        private static void CreateDirectories()
        {
            if (!Directory.Exists("Export"))
            {
                ...
                if (!Directory.Exists("Export\\Json"))
                {
                    Directory.CreateDirectory("Export\\Json");
                }
        ...
        private static void ExportUsersAndProductsXml()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                document.Save("Export\\Xml\\04.UsersAndProductsXml.xml");
            }
        }
        ...
        private static void ExportCategoriesByProductsCountXml()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                document.Save("Export\\Xml\\03.CategoriesWithProductsXml.xml");
            }
        }
        ...
        private static void ExportSoldProductsXml()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                document.Save("Export\\Xml\\02.UsersWithSoldProductsXml.xml");
            }
        }
        ...
        private static void ExportProductsInRangeXml()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                document.Save("Export\\Xml\\01.ProductsInRangeXml.xml");
            }
        }

        private static void ImportCategoriesXml()
        {
            XDocument document = XDocument.Load("Import/categories.xml");
        ...
        private static void UsersAndProducts()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                File.WriteAllText("Export\\Json\\04.UsersWithSoldProductsJson.json", userProductsJson);
            }
        }
        ...
        private static void ExportCategoriesByProductsCount()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                File.WriteAllText("Export\\Json\\03.CategoriesByProductsCountJson.json", categoriesJson);
            }
        }
        ...
        private static void ExportSuccessfullySoldProducts()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                File.WriteAllText("Export\\Json\\02.UsersWithSoldProductsJson.json", usersJson);
            }
        }
        ...
        private static void ExportProductsInRange()
        {
            using (ProductsShopContext context = new ProductsShopContext())
            {
                ...
                File.WriteAllText("Export\\Json\\01.ProductsInRangeJson.json", productsJson);
            }
        }
